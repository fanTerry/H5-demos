...
public class IndexManager {
	...
	public CommonResponse<JSONObject> getIndexData( IndexRequest indexRequest){
		...
		try {
			...
			/** 加载首页栏目 */
			SysConfigProperty property = commonManager.getSysConfigByKey(SysConfigPropertyKey.INDEXPAGE_CHANNEL_CONFIG,indexRequest.getClientType(),indexRequest.getAgentId());
