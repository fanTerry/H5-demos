      ...
      <div class="flex_hc">
        ...
        <div class="team_pk">
          <div class="flex_hc">
            ...
            <p class="team_name" :class="{'joined':item.joinTeamId&&item.joinTeamId==item.homeTeamId}">
              {{item.homeTeamName}}</p>
            <!-- 主辦方 -->
          ...
          <div class="flex_hc">
            ...
            <p class="team_name" :class="{'joined':item.joinTeamId&&item.joinTeamId==item.awayTeamId}">
              {{item.awayTeamName}}</p>
            <!-- 主辦方 -->
            <div class="match_result owner"
