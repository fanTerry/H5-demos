...
// 默认的动动竞猜赛事队伍logo
const dDmatchTeamDefaultIcon = 'https://rs.esportzoo.com/svn/esport-res/mini/images/default/dd_default_team.png';
//默认用户头像
const userDefaultIcon = 'https://rs.esportzoo.com/svn/esport-res/mini/images/icon/avatar.png';
//小游戏默认用户头像
const xyxUserDefaultIcon = 'https://rs.esportzoo.com/svn/esport-res/ddquiz/images/logo/default.png';
//友宝充值地址
