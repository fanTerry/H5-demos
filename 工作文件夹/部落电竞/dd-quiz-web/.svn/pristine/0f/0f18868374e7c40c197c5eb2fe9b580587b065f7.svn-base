<template>
  <div class="ui_pop" v-if='step1Flag||step2Flag'>
      ...
      <div class="exchange_num">
        ...
        <div class="data">
          ...
          <input class="num" maxlength="4" type="tel"
            onKeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))" @blur="scrollToTop"
            v-model.number.lazy="finalNum">
    ...
    <section class="receive_adress" v-if='step2Flag&&needAddressFlag'>
      ...
      <template v-if="hasDefaultAddress||receiveAddress!=null">
        ...
        <div class="order_remarks">
          <span>订单备注</span>
          <textarea v-model="remark" @blur="scrollToTop" cols="30" rows="4" maxlength="50"
    ...
    <popUp v-if="showPay" @close="closePayDialog" ref="popUpRef" :price="(finalNum*1000*goodsDetail.payScore).toFixed(2)"
      unit='星星' @chooseWay="chooseWay">
    </popUp>
