  ...
  <div class="ui_pop">
    ...
    <div class="pointsExchange">
      ...
      <div class="pointsExchange_con">
        <p class="rules">1000星星=嗨乐积分，奖励积分可用于奖励兑换</p>
        <div class="exchange_box">
          ...
          <div class="exchange_tips"><span>星星</span><span>嗨乐积分</span></div>
        </div>
        ...
        <!-- 输入兑换数量后加active -->
        <p class="att_tips {active:showNum}" v-if="showNum">嗨乐积分：{{starNum/1000}}</p>
      ...
      <div class="exchange_pop_rules" v-if="showRulesPop">
        ...
        <p>1000星星兑换1嗨乐积分，嗨乐积分可以在椰子商城兑换各种商品。</p>
  ...
  methods: {
    ...
    affirmStarExchange() {
      if (this.starNum < 1000) {
        ...
        return this.$post("/api/haiLeUser/exchangeHaileScore", param)
          .then(rsp => {
