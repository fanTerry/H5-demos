  ...
  <div class="ui_pop">
    ...
    <div class="pointsExchange">
      ...
      <div class="pointsExchange_con">
        ...
        <div class="tab">
          <span :class="{'active': tabCheck == 0}" @click="switchPointType(0)">兑换椰子分</span>
        ...
        <!-- 输入兑换数量后加active -->
        <p class="att_tips {active:showNum}" v-if="showNum">可兑换{{pointNameArray[tabCheck]}}分：{{starNum/1000}}</p>
      ...
      <div class="exchange_pop_rules" v-if="showRulesPop">
        ...
        <p>
          1000星星兑换1{{pointNameArray[tabCheck]}}积分，{{pointNameArray[tabCheck]}}积分可以在{{pointNameArray[tabCheck]}}商城兑换各种商品。
        </p>
      ...
      return this.$post(reqUrl, param)
        .then(rsp => {
          ...
          if (dataResponse.code == 200) {
            ...
            //更新积分钱包
            let point = param.walletScore / 1000;
            if (this.tabCheck == 0) {
              this.setUserInfo({
                ...this.getUserInfo,
