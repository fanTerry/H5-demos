  ...
  <div class="Page">
    ...
    <div class="main">
      ...
      <section v-if="type ==1">
        ...
        <input type="text" id="nick" v-model="userInfo.nickName" placeholder="4-14位汉字、字母和数字的组合" minlength="4"
          maxlength="14" @blur="scrollToTop">
      </section>

      <section class="personal_sign" v-if="type ==2">
        <label for="p_sign">个人简介</label>

        <textarea v-model="userInfo.intro" name="" id="p_sign" cols="10" rows="10" placeholder="不能超过50个字符"
          maxlength="50" @blur="scrollToTop"></textarea>
      </section>
...
export default {
  ...
  methods: {
    ...
    submitData() {
      ...
      if (
        this.type == 1 &&
        (!getCheck.checkName(this.userInfo.nickName) ||
          this.userInfo.nickName.length > 14)
      ) {
      ...
      if (this.type == 4 && !getCheck.checkId(this.userInfo.certNo)) {
