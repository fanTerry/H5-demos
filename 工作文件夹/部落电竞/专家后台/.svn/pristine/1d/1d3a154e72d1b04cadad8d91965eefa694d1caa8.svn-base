...
<div class="text_nocenter pub_list_jczq" style="display: block;">
	...
	<table id="jclq_2c1_table" class="BMTable">
	...
	<div id="jq_return_rate">方案最低返奖率须≥<fmt:formatNumber type="number" value="${lqCgProfitRatio*100}" maxFractionDigits="0"/>%,当前推荐单最低返奖率:<span id="jq_prize_rate" style="color:red">0</span>%</div>
</div>