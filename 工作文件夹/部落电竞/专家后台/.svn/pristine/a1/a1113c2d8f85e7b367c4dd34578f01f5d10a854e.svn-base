...
<div class="content clearfix">
    ...
    <div class="aside">
        <div class="wrap1080 ppd70">
            <div class="fs30 c333 pl40 pt30">修改实名认证：</div>
            <form action="/uc/updateAuthCertNo" method="post" id="do-login">
            <div class="login_form tac pt40">
                ...
                <div class="inputBox">
                    ...
                    <input  id="phone" name="phone" value="${member.phone}" maxlength="30" readonly="readonly">
                </div>
                <div class="inputBox">
