...
<body class="admin_bg">
            ...
            <div class="wrap1080 ppd70"> 
            	...
            	<ul class="addInputUl">
            		<li class="clearfix">
            			...
            			<input type="text" id="jq_id" value="${profitPlan.id}" name="id" readonly>
            		</li>
            		<li class="clearfix">
            			<div class="fl w200 ml40">
            				<span class="red">*</span>
            			...
            			<input type="text" id="jq_title" value="${profitPlan.title}" name="title">
            		</li>
            		<li class="clearfix">
            			<div class="fl w200 ml40">
            				<span class="red">*</span>
            			...
            			<input type="text" id="jq_logo" name="imgAdress" value="${profitPlan.imgAdress}" style="width:500px;" >
            		...
            		<li class="clearfix">
            			...
            			<select name="playType" id="jq_paly_type" class="w200" disabled="disabled">
                        	<c:forEach var="item" items="${allProfitPlayType}">
                        		<option <c:if test="${item.index == profitPlan.playType}">selected</c:if> value="${item.index}" >${item.description}</option>
                        	</c:forEach>
                    	</select>
            		</li>
            		<li class="clearfix">
            			...
            			<select name="riskType" id="jq_risk_type" class="w200">
                        	<c:forEach var="item" items="${allProfitRiskType}">
								<option <c:if test="${item.index == profitPlan.riskType}">selected</c:if> value="${item.index}" >${item.description}</option>
							</c:forEach>
                    	</select>
            		</li>
            	</ul>
            	<div class="mt30">
	                ...
	                <ul id="jq_price" name="price" class="profit_price" style="display:inline-block;vertical-align: middle; margin-left:100px;">
	                    <input name="price" type="radio" value="58" <c:if test="${'58.00' eq profitPlan.price}">checked="checked"</c:if> /> 58金币 
	            		<input name="price" type="radio" value="68" <c:if test="${'68.00' eq profitPlan.price}">checked="checked"</c:if> /> 68金币 
	            		<input name="price" type="radio" value="88" <c:if test="${'88.00' eq profitPlan.price}">checked="checked"</c:if> /> 88金币
	            		<input name="price" type="radio" value="108" <c:if test="${'108.00' eq profitPlan.price}">checked="checked"</c:if> /> 108金币
	            		<input name="price" type="radio" value="128" <c:if test="${'128.00' eq profitPlan.price}">checked="checked"</c:if> /> 128金币
	                </ul>
	            </div>
	            <ul class="addInputUl">
            		<li class="clearfix">
            			...
            			<input type="text" id="jq_features" name="profitFeatures"  value="${profitPlan.profitFeatures }" placeholder="示例：平赔模型，3单中1单" maxlength="15"><span style="margin-left: 10px;color:red;">限15字以内</span>
            		</li>
            		<li class="clearfix">
            			<div class="fl w200 ml40">
            				<span class="red">*</span>
            			...
            			<input type="text" id="jq_send_freq" name="sendFreq" value="${profitPlanDetails.sendFreq}" placeholder="示例：一个方案结束后发布另一个方案" >
            		</li>
            		<li class="clearfix">
            			<div class="fl w200 ml40">
            				<span class="red">*</span>
            			...
            			<input type="text" id="jq_win_multiple" name="winMultiple" value="${profitPlanDetails.winMultiple}" placeholder="示例：2.5-5.0倍">
            		</li>
            		<li class="clearfix">
            			<div class="fl w200 ml40">
            				<span class="red">*</span>
            			...
            			<input type="text" id="jq_week_send" name="weekSend" value="${profitPlanDetails.weekSend}" placeholder="示例：5单左右，主要集中在周5、6、7">
            		</li>
            		<li class="clearfix">
            			<div class="fl w200 ml40">
            				<span class="red">*</span>
            			...
            			<input type="text" id="jq_avg_win_freq" name="avgWinFreq" value="${profitPlanDetails.avgWinFreq}" placeholder="示例：平均3单中1单" >
            		</li>
            		<li class="clearfix">
            			<div class="fl w200 ml40">
            				<span class="red">*</span>
            			...
            			<input type="text" id="jq_predict_max_lost" name="predictMaxLost" value="${profitPlanDetails.predictMaxLost}" style="width: 100px;"placeholder="示例：10"><span style="margin-left: 10px;color:red;">限输入数字</span>
            		</li>
            		<li class="clearfix">
            			<div class="fl w200 ml40">
            				<span class="red">*</span>
            			...
            			<input type="text" id="jq_user_rank" name="suitUser" value="${profitPlanDetails.suitUser}" placeholder="示例：有一定耐心，持续跟单一小段时间" >
            		</li>
            	</ul>
	            ...
	            <div class="game_reason">
	            	<div class="intro_reason intro_reason2">
	                	...
	                	<div style="margin-left:80px;margin-top:-20px">
	                		<textarea id="jq_provide_desc" name="provideDesc" placeholder="请输入服务商介绍！（注：内容不得含非法、虚假内容或联系方式）">${profitPlan.provideDesc}</textarea>
						</div>
	                </div>
	                <div class="intro_reason intro_reason2">
	                	<span>盈利计划介绍：</span>
	                	<div style="margin-left:80px;margin-top:-20px">
	                		<textarea id="jq_description" name="description" placeholder="请输入盈利计划的详细介绍！（注：内容不得含非法、虚假内容或联系方式）">${profitPlan.description}</textarea>
						</div>
	                </div>
	...
	<div id="dialog-success" class="pub_success" style="display:none">
        ...
        <p class="success_word">盈利计划提交审核成功...</p>
