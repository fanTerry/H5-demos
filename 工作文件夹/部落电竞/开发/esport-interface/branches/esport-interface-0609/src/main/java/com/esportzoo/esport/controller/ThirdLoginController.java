...
/*			String h5Domain = "https://m.esportzoo.com";
			...
			String apiDomain = uboxH5Manager.getApiDomain(request);
			String redirectUrl = "";
			try {
	...
	public ModelAndView uboxSendOauthRequest1(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			String callBackUrl = uboxH5Manager.getOauthRequestUrl1(request,redirectUrl, agentId);
	...
	public ModelAndView uboxCallBack1(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			logger.info(logPrefix + "uboxAuthCode={},callBackUrl={},agentId={},biz={},跳转标记：【sp={}】,调试参数：【debug={}】", uboxAuthCode, callBackUrl, agentId, biz,sp,debug);
