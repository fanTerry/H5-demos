...
public class UboxH5Manager {
	...
	public String getOauthRequestUrl1(HttpServletRequest request,String redirect, String agentId) throws Exception {
		String callBackUrl = getApiDomain(request) + "/third/uboxcallback1?agentId=" + agentId + "&callBackUrl=" + redirect ;
