...
public class RecExpertColumnArticleResponse implements Serializable {
	...
	/** 关联竞猜赛事信息 */
	private List<QuizMatch> quizMatchResultList;
	...
	public List<QuizMatch> getQuizMatchResultList() {
		return quizMatchResultList;
	}

	public void setQuizMatchResultList(List<QuizMatch> quizMatchResultList) {
		this.quizMatchResultList = quizMatchResultList;
	}
}
