...
export default {
  ...
  mounted() {
    ...
    this.uploadImgUrl = '/agency/user/updateUserInfo?agentId=' + this.baseParamConfig.agentId + '&biz=' + this.biz + '&clientType=' + this.clientType;
  ...
  methods: {
    ...
    changeImage($event) {
      ...
      return this.$axios
        .post('/agency/user/updateUserInfo', form)
        .then(rsp => {
...
.item {
  ...
  .link_icon {
    ...
    @include getArrow(2.6667vw, rgba(0, 0, 0, 0.3), right);
  }
  .personal_sign {
