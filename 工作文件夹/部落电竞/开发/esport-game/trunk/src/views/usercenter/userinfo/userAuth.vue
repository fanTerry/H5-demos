  ...
  <div class="Page userAuthPage">
    ...
    <div class="main">
      ...
      <section>
        ...
        <input v-model="userInfo.trueName" id="real_name" type="text" maxlength="20" placeholder="请输入真实姓名"
          @blur="scrollToTop">
      </section>
      ...
      <div class="phonecode_div">
        <phone-send-code ref='phoneSend' :time="60" btnTxt="提交" @doConfirm="toDoConfirm"
          @getSendPhoneCode="getSendPhoneCode">
        </phone-send-code>
      </div>
      <div class="tips" style='color:black'>
        若出现<span style="color:red;">'身份信息验证不通过'</span>时，原因如下：<br>
...
export default {
  ...
  methods: {
    ...
    toDoConfirm(phone, phoneCode) {
      ...
      console.log(param);
      this.$post("/agency/user/realNameCheck/", param)
        .then(rsp => {
