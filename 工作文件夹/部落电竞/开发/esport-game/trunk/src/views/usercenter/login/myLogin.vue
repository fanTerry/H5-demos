<template>
  <div :class="isJuzi?'juziPage':'Page'" class="userCenterPage">
...
export default {
  ...
  methods: {
    ...
    judgeCanRegister() {
      this.$post('/agency/judgeCanRegister')
        .then(rsp => {
    ...
    qqLoginClick(value) {
      ...
      window.location.href = '/agency/qqlogin/toqqlogin?redirect=' + url;
    },
    ...
    accountLogin() {
      ...
      this.$post('/agency/phonelogin/', param)
        .then(dataResponse => {
    ...
    phoneSendCodeLogin(phone, phoneSendCode) {
      ...
      this.$post('/agency/phoneCodeLogin', param)
        .then(dataResponse => {
    ...
    getSendPhoneCode(phone) {
      ...
      this.$post('/agency/user/sendPhoneCode', param)
        .then(dataResponse => {
...
.Page {
  background-image: url('../../../assets/images/user_center/logo.png'), url('../../../assets/images/user_center/login_logo.png');
  background-position: center 8.9333vw, center top;
  background-repeat: no-repeat, no-repeat;
  background-size: 42.9333vw, 100% auto;
}
.juziPage {
...
.main {
  position: relative;
  padding: 54vw 2.6667vw 5.3333vw;
  .container {
    padding-top: 26px;
    padding-bottom: 22px;
