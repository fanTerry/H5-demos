  ...
  <div v-if="dataItem" @click="toComment(dataItem.commentId,dataItem.usrName)">
    ...
    <div class="con">
      ...
      <div class="feedback_item">
        ...
        <div class="feedback_icon delete_icon" v-if="dataItem.currentUserCreate" @click.stop="toDelComment(dataItem.commentId,dataItem.replies)"></div>
      </div>
...
export default {
  ...
  methods: {
    ...
    toDelComment(commentId,replies) {
      ...
      console.log(commentId,replies,"11111122")
      this.$emit("toDelComment", commentId,replies);
