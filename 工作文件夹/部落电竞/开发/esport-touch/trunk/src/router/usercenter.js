...
const salesExtend = () => import('../views/usercenter/salesextend/index.vue');
const pullNews = () => import('../views/usercenter/salesextend/pullnews.vue');
const productAdver = () => import('../views/usercenter/salesextend/product_adver.vue');
...
export default [{
    ...
    path: '/userCenter/salesExtend',
    name: 'salesExtend',
    component: salesExtend,
}, {
    path: '/userCenter/salesExtend/pullNews',
    name: 'pullNews',
    component: pullNews,
}, {
    path: '/userCenter/salesExtend/productAdver',
    name: 'productAdver',
    component: productAdver,
}, {
    path: '/userArticle',
    name: 'userArticle',
