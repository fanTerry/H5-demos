<template>
  <div class="Page myReleasePage">
    <header class="mod_header">
      <navBar :pageTitle="'我的记录'"></navBar>
      <nav class="nav_list">
    ...
    <div class="main" id="mainId">
      <mescroll ref="mescroll" @downCallback="downCallback" @upCallback="upCallback" @mescrollInit="mescrollInit">
        ...
        <section class="mod_expert">
          ...
          <!-- 文章列表组件 -->
          <articleTab :cmsContentList="cmsContentList" :videoType="1" :showCommon="2"></articleTab>
        </section>
...
export default {
  ...
  created() {
    if (sessionStorage.get('tabIndex')) {
