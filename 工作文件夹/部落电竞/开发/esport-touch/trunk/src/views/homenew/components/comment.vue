  ...
  <div class="Page comment_pop">
    ...
    <div class="main" id='mainId'>
      <mescroll ref="mescroll" :downLoadAuto="false" :isUseDown="false" @upCallback="onPullingUp" @mescrollInit="mescrollInit">
        ...
        <article-discuss-item v-for="(dataItem,index) in commentList" :showType='1' :key="index+'cms1'" @refreshComment="refreshComment" :ref="'myChildHot'+dataItem.commentId" :commentItem="dataItem"
        ...
        <div class="replys">
          ...
          <article-discuss-item v-for="(dataSubItem,index) in subCommentList" :showType='2' :key="index+'cms2'" @refreshComment="refreshComment" :ref="'myChild'+dataSubItem.commentId"
            :commentItem="dataSubItem" :hotFlag="0" @toReplyFocus="replyFocus" @toDelComment="toDelComment">
          </article-discuss-item>
          <!-- </template> -->
        </div>
...
export default {
  ...
  methods: {
    ...
    onPullingUp() {
      ...
      if (this.queryParam.pageNo != 1 && this.queryParam.pageNo > this.totalPages) {
        ...
        .then(rsp => {
          ...
          if (dataResponse.code == '200') {
            ...
            if (dataResponse.data.subCommentList != null) {
              this.subCommentList = this.subCommentList.concat(dataResponse.data.subCommentList);
