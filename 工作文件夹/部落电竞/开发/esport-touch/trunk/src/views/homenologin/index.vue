<template>
  <div class="Page orangeGamePage">
    ...
    <div class="main" id='mainId'>
      <mescroll id="mescroll" :class="{'video_bg':tabFlag == 2}" ref="mescroll" :isShowEmpty="false"
        ...
        <div class="scroll_wrapper">
          ...
          <nav-list v-if="tabFlag == 1" :dataList="channelList" @changeTab="relodDataByTab"></nav-list>
            ...
            <template v-for="(item,index) in newsList">
              <article class="item" v-if="item.type==1 " @click="toCmsDetail(item.aricleId,item.type)" :key="index">
                <div class="item_left">
                  ...
                  <div class="user_info">
                    <div class="flex_hc">
                      <img v-if='!judeIsJuzi()' class="user_img"
                        :src="item.authorImg|getDefaultImg('https://rs.esportzoo.com/svn/esport-res/mini/images/default/winplus.png')"
                        alt="">
                      <img v-else class="user_img"
                        src="https://rs.esportzoo.com/svn/esport-res/mini/images/default/juzi.png">
                      <!-- <div> -->
              ...
              <article class="item film_item" v-else-if="item.type==2" :key="index">
                <div class="film_con">
                  ...
                  <xi-gua-video ref="xiGuaVideo" :videoUrl="item.imageSrc"
                    :poster='require("../../assets/images/common/video_default_image.png")' :videoId="item.aricleId"
                    scene="home">
                  </xi-gua-video>
                </div>
              </article>
      ...
      <!-- 没有数据时展示 -->
      <no-data v-if="noData" :text="'暂无'+ tabList[tabFlag]"
...
export default {
  ...
  mounted() {
    if (this.$route.query && this.$route.query.tab) {
      ...
      this.tabFlag = this.$route.query.tab;
      if (this.tabFlag == 1) {
        console.log(this.$route.query.tab,"88744444");
        this.contentType = 2;
      } else {
        this.contentType = this.$route.query.tab;
      }
    } else {
      this.contentType = 0;
      this.tabFlag = 0;
  ...
  methods: {
    ...
    switchTab(index) {
      ...
      if (index == 1) {
        window.sessionStorage.selectedTab = index + 1;
        this.videoTypeIndex = index + 1;
