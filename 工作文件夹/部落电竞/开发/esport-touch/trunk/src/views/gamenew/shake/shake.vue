    ...
    <div class='main'>
      <div>
        <div class="tree">
          ...
          <!-- 奖品掉落球 -->
          <img class="prize_img" :class="{'active':gameShake.gameBingo}" @animationend="ballDropOut()" src="../../../assets/images/game/newshake/ball.png" alt="" style="">
          <!-- 中奖物品 -->
          <template v-if='gameShake.playRes'>
            <div class="awards" :class="{'more_awards':gameShake.playRes.awardScoreValue/gameShake.playRes.consumeScore>1}">
          ...
          <div class="play">
            <div class="bet" v-if='roomInfo.playItems'>
              <div class="power" @click="showPowerList( $event)">
                ...
                <ul v-if="shutFlag">
                  <li>摇晃力量</li>
                  <li v-for="(item,index) in roomInfo.playItems" :key="index" :class="{'active':roomInfo.selectPlayItem.itemScore == item.itemScore}" @click="selectPower(index,$event)">
                    {{item.itemScore}}
                  </li>
                </ul>
...
.tree {
  ...
  .more_awards .award_packs {
    ...
    height: 77.3333vw;
    &.active {
      @include getBgImg('../../../assets/images/game/newshake/shine_strong.gif');
    }
  }
  .award_num {
    position: absolute;
  ...
  .songshu {
    ...
    &.active {
      width: 25.7333vw;
      height: 39.4667vw;
      @include getBgImg('../../../assets/images/game/newshake/songshu_sprite.png');
      background-position: 0 0;
...
.voice {
  ...
  &.muted {
    @include getBgImg('../../../assets/images/game/newshake/voice_forbidden.png');
  }
}
...
.mod_footer {
  ...
  .power {
    ...
    ul {
      ...
      li {
        ...
        text-align: center;
        color: #fff;
        @include getBgImg('../../../assets/images/game/newshake/shangla_off.png');
        border-radius: 8.8vw;
        &:first-child {
          width: 100%;
          height: 10.6667vw;
        ...
        &.active {
          font-weight: bold;
          color: #f64500;
          @include getBgImg('../../../assets/images/game/newshake/shangla_on.png');
        }
      }
    }
    .num {
  ...
  .game_hook {
    ...
    &.active {
      @include getBgImg('../../../assets/images/game/newshake/game_hooking.png');
    }
    span {
      @extend .g_c_mid;
      top: -6.6667vw;
