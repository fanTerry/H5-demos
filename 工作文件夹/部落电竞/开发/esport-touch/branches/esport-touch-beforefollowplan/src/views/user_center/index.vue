      ...
      <section class="exchange_store">
        ...
        <section class="store">
          ...
          <div class="store_item" @click="goToYeYunPage()">
            <img src="https://rs.esportzoo.com/upload/admin/cmsContent/2020/6/8/yezinew_1591611649664.jpg" alt="">
...
export default {
  ...
  mounted() {
    // this.isShowJinli(); //渠道判断是否显示锦鲤兑换商城
    this.getUserInfo();
  ...
  methods: {
    ...
    // isShowJinli() {
    //   let agentIdArray = ['200005', '200002', '10002'];
    //   let agentId = this.$route.query.agentId;
    //   if (agentIdArray.indexOf(agentId) != -1) {
    //     this.storeList.showJinli = true;
    //   }
    // }
