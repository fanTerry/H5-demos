...
.tree {
  ...
  .tree_leaf {
    ...
    width: 90.4vw;
    height: 81.3333vw;
    @include getBgImg("../../../assets/images/game/shake/tree_leaf.gif");
    &::after {
      content: "";
      @extend .g_c_mid;
      top: 35.2vw;
  ...
  .songshu_gif {
    ...
    width: 36.5333vw;
    height: 41.2vw;
    @include getBgImg("../../../assets/images/game/shake/songshu_sprite.png");
    background-position: 0 0;
    background-size: 365.3333vw;
    &.active {
      animation: bitTreeAnimate 1.42s step-end both;
    }
  }
  .songshu_gif {
    width: 0;
...
@keyframes bitTreeAnimate {
  ...
  10% {
    background-position: -328.8vw 0;
  }
  // 第一段
  11% {
    background-position: 0 -41.2vw;
  }
  20% {
    background-position: -328.8vw -41.2vw;
  }
  // 第二段
  21% {
    background-position: 0 -82.4vw;
  }
  30% {
    background-position: -328.8vw -82.4vw;
  }
  // 第三段
  31% {
    background-position: 0 -123.6vw;
  }
  40% {
    background-position: -328.8vw -123.6vw;
  }
  // 第四段
  41% {
    background-position: 0 -164.8vw;
  }
  50% {
    background-position: -328.8vw -164.8vw;
  }
  // 第五段
  51% {
    background-position: 0 -206vw;
  }
  60% {
    background-position: -328.8vw -206vw;
  }
  // 第六段
  61% {
    background-position: 0 -247.2vw;
  }
  70% {
    background-position: -328.8vw -247.2vw;
  }
  // 第七段
  71% {
    background-position: 0 -288.4vw;
  }
  80% {
    background-position: -328.8vw -288.4vw;
  }
  // 第八段
  81% {
    background-position: 0 -329.6vw;
  }
  90% {
    background-position: -328.8vw -329.6vw;
  }
  // 第九段
}
