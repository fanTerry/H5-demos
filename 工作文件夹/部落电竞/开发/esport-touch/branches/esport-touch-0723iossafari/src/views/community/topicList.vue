<template>
  <div class="Page topicListPage">
    <header class="mod_header">
      ...
      <div class="tab">
        <div @click="gotoRecommend()">推荐</div>
        ...
        <section class="myfollow_tab" v-if="currTab==2">
          ...
          <div class="user_list">
            ...
            <div v-for="(value,key)  in topicList" :key="key">
              <h2 :id="key">{{key}}</h2>
              <topic @follow="follow" :topicItem="item" :type="key" :itemIndex="index" v-for="(item,index) in value" :key="index"></topic>
            </div>
          </div>
        </section>
...
export default {
  ...
  methods: {
    ...
    follow(param) {
      ...
      this.topicList[param.type][param.itemIndex].attention = param.followStatus;
      // console.log("8888",);
    },
    changeTab(tab) {
      if (this.currTab == tab) {
