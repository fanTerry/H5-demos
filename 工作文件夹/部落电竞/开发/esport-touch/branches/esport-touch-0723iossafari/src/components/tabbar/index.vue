<template>
  <section class="tabbar">
    <ul>
      ...
      <!-- v-show='showGuess||inviteCodeType' -->
      <li @click="gotoAddress({path: '/guess/home', query: {}})" :class="{cur:$route.path.indexOf('/guess/home')!== -1}">
        <i class="guess"></i>
        <span>预测</span>
      </li>
      ...
      <!-- v-show='(showGuess||inviteCodeType) && systemUser'  -->
      <li @click="gotoAddress({path: '/followPlan', query: {}})" :class="{cur:$route.path.indexOf('followPlan')!== -1}">
...
.cur {
  color: #fff;
  .home {
    @include getBgImg('../../assets/images/common/home_cur.png');
    background-size: 100% auto;
  }
  .community {
    @include getBgImg('../../assets/images/common/community_cur.png');
    background-size: 100% auto;
  }
  // .store {
  ...
  // }
  .guess {
    @include getBgImg('../../assets/images/common/guess_cur.png');
    background-size: 100% auto;
  }
  .follow_plan {
    @include getBgImg('../../assets/images/common/follow_plan_cur.png');
    background-size: 100% auto;
  }
  .user_center {
    @include getBgImg('../../assets/images/common/user_center_cur.png');
    background-size: 100% auto;
  }
}

.home {
  @include getBgImg('../../assets/images/common/home.png');
  background-size: 100% auto;
}

.community {
  @include getBgImg('../../assets/images/common/community.png');
  background-size: 100% auto;
}
// .store {
...
// }
.guess {
  @include getBgImg('../../assets/images/common/guess.png');
  background-size: 100% auto;
}
.follow_plan {
  @include getBgImg('../../assets/images/common/follow_plan.png');
  background-size: 100% auto;
}
.user_center {
  @include getBgImg('../../assets/images/common/user_center.png');
  background-size: 100% auto;
}
</style>
