      ...
      <div class="rule_list" v-show='mark'>
        <ul>
          ...
          <li><span>3.</span> 奖项与规则：
            <br>一等奖（详见首页“今日头奖”）-最先连对20题
            <br>二等奖（288点券王者皮肤）-最先连对19题
            <br>普照奖（0.3元现金红包）-连对14题及以上
          </li>
          <li><span>4.</span>获奖者可联系枫叶电竞微信客服：jzdj08
          </li>
          <!-- <li><span>5.</span> 枫叶电竞官方商城1星星等值1元人民币，可累计不可提现，须在两日内消费，否则系统将判定失效收回。
          </li>
          <li><span>6.</span> 枫叶电竞（可检索微信订阅号、服务号），通过菜单进入官网及商城。</li>
