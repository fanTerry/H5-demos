  ...
  <div class="Page">
    ...
    <div class="main mescroll-touch-y">
      <div class="select_topic">
        <span>选择话题</span>
        <span class="topic" :class="{'active':topicName}" @click="showTopicList = true">{{topicName?topicName:"选择相关话题,可获取更多曝光哦"}}</span>
      </div>
      <section class="mod_publish">
        ...
        <div :class="type==3?'publish_essays':'publish_img'" @click="bindFocus()">
          <div class="publish_txt">
            ...
            <textarea class="essays" v-model="content" @input="handleInput" @focus="bindFocus($event)" @blur="scrollToTop" name="" id="" maxlength="200" placeholder="来叨叨两句吧~（200个字符以内）"
          ...
          <div class="add_container" v-if="type==3">
            ...
            <div class="add_item" v-if="imgs.length<maxSize">
              ...
              <img src="" alt="" ref="img">
              <input style="position:absolute;opacity:0;" type="file" multiple id='files' @change="fileChange($event)" ref="input" accept="image/*">
            </div>
          ...
          <div class="add_container" v-if="type==5">
            ...
            <div class="add_item">
              ...
              <input style="position:absolute;opacity:0;" type="file" id='pop_video' @change="uploadVideo($event)" ref="file" accept="video/*" v-if='!showVideo'>
              <!--capture="camcorder" -->
            </div>
      ...
      <section class="ui_pop mod_project" v-if="showTopicList">
        <div class="project_con">
          ...
          <div class="topic_talk">
            ...
            <template v-else>
              ...
              <div class="top_cms_topic">
                <topic-list v-for="(value,index) in topCmsTopicList" :value='value' :key="index" @selectTopic='selectTopic'>
                </topic-list>
              </div>
          ...
          <aside class="sidebar">
            ...
            <a class="letter" :class="index == sideBarFlag?'active':''" @click="sideBarFlag = index" v-for="(item,index) in letterList" :key="index" :href="'#'+item">{{item}}</a>
          </aside>
        </div>
      </section>
    </div>
