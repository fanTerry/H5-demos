  ...
  <div class="Page">
    <div class="main">
      ...
      <div class="option_group">
        <!-- 答对加active -->
        <div :class="{'active': index == active}" v-for="(item ,index) in currSubject.hdSubjectOptions" :key="index"
    ...
    <!-- 弹窗集合组件 -->
    <pops ref="popRef" :shareCode='shareCode' @reStartTimeCountDown="reStartTimeCountDown"
      @payToRestartGame="payToRestartGame"></pops>
