<template>
  <div class='Page godPage'>
    <header class='mod_header'>
      <nav-bar :pageTitle="'专家方案'"></nav-bar>
    </header>
    <div class='main'>
      <!-- 大神信息 -->
    ...
    <pop-pay-project></pop-pay-project>
...
import popPayProject from '../components/popPayProject.vue';

export default {
  components: { navBar, masterInfo, expertProjectItem, popPayProject },
  props: [],
  data() {
    return {};
  },
