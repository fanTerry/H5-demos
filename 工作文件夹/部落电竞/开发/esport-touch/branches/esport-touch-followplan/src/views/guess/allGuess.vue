<!--
 * @Author: your name
 * @Date: 2020-06-15 16:57:38
 * @LastEditTime: 2020-06-16 16:37:21
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /esport-touch-followplan/src/views/guess/allGuess.vue
--> 
<template>
...
export default {
  ...
  beforeRouteEnter(to, from, next) {
    if (from.name == 'recharge' || from.name == 'recommendPlanDetail' ) {
      // 这个name是下一级页面的路由name
  ...
  methods: {
    ...
    onClickRefresh() {
      ...
      if (this.tabType == 1) {
        ...
        this.$refs.followPlan.downCallback();
      }
    },
    //获取当前页面所有数据
    getCurrPageData() {
