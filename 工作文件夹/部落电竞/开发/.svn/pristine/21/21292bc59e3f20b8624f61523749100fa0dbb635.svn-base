...
// 12-20首页改版用homenew代替
const home = () => import('./views/homenew/notice.vue');
...
const salesManage = () => import('./views/user_center/salesManage.vue');
...
const myRelease = () => import('./views/user_center/article/myRelease.vue');
...
const myMessage = () => import('./views/user_center/article/myMessage.vue');
const myFollow = () => import('./views/user_center/follow/myFollow.vue');
const myFans = () => import('./views/user_center/follow/myFans.vue');
const userPublishArticle = () => import('./views/user_center/article/myPublishArticle.vue');
const myLikeArticle = () => import('./views/user_center/article/myUpCmsArtcle.vue');



// 预测
// const guessHome = () => import('./views/guess/home/wsHome.vue');
// const allGuess = () => import('./views/guess/allGuessWs.vue');
...
const test = () => import('./views/home/videoLive.vue');
...
//专家
const followPlan = () => import('./views/guess/followplan/followPlan.vue');
const godPage = () => import('./views/guess/followplan/godpage/godPage.vue');
