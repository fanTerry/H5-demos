    ...
    <div class="main">
      <section class="draw_info">
        ...
        <div class="draw_input draw_textarea">
          ...
          <textarea v-model="applyParam.introduction" name="" id="" cols="20" rows="10" maxlength="100"
            placeholder="不超过100个字符，请勿包含政治，色情，广告等违规信息 " @blur="bindBlur()"></textarea>
        </div>
      </section>
      ...
      <section class="draw_reason">
        <div class="draw_input draw_textarea">
          ...
          <textarea v-model="applyParam.reason" name="" id="" cols="20" rows="10" maxlength="100"
            placeholder="不超过100个字符，请勿包含政治，色情，广告等违规信息" @blur="bindBlur()"></textarea>
        </div>
      </section>
  ...
  methods: {
    ...
    checkForm() {
      ...
      if (
        ...
        this.$refs.input.files[0].size > limitSize
      ) {
