...
export default {
  ...
  methods: {
    ...
    gotoCharge: function() {
      ...
      this.$post("/agency/payment/getPayWayList", {
        needRecPay: false
      })
        .then(rsp => {
    ...
    confirmCharge: function(chooseChargeWay, chargeWayBalance) {
      ...
      this.$post("/agency/h5charge/tocharge", param)
        .then(rsp => {
          const dataResponse = rsp;
    ...
    getChargePageData: function() {
      return this.$post("/agency/charge/iapAmountList")
        .then(res => {
    ...
    applePayCallBack(result, requestParams) {
      ...
      this.$post("/agency/h5charge/applePayCallBack", param)
        .then(res => {
