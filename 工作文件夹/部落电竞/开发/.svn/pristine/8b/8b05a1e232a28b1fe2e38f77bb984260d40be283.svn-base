      ...
      <div class='main' id="mainId">
        ...
        <section class="bills_detail">
          <div class="mod_title">
            ...
            <span class="flex_hc">发单规则<i class="rules_icon" @click="popUps.billRules = true"></i></span>
          </div>
          <div class="info">
      ...
      <div class="ui_pop " v-if="popUps.billRules">
        <div class="pop_bill_rules">
          ...
          <div class="con">
            ...
            <div>
              <p>1. 订单金额 <span>≥1000</span> 枫叶</p>
              <p>2. 跟单盈利方案 <span>≥120%</span> </p>
            </div>
            <p class="tips">若玩家预测过程中由于题目赔率变化返还率
              ＜120%，用户下单将不计入佣金统计，大神
              每日可最多发布5条跟单，可获得玩家订单奖
              励的5%佣金</p>
          </div>
...
.send_bill_btn {
  display: block;
  @include getBtn(91.4667vw, 9.0667vw, 4vw, #fff, $color_main, 0.8vw);
  margin: 2vw auto;
  font-weight: bold;
}
