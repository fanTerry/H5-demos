<template>
  <section class="tabbar">
    <ul>
      ...
      <li v-show='showGuess||inviteCodeType' @click="gotoAddress({path: '/guess/home', query: {}})" :class="{cur:$route.path.indexOf('/guess/home')!== -1}">
        <i class="guess"></i>
        <span>预测</span>
      </li>
      ...
      <li v-show='(showGuess||inviteCodeType) && systemUser' @click="gotoAddress({path: '/followPlan', query: {}})" :class="{cur:$route.path.indexOf('followPlan')!== -1}">
