<template>
  <div class="ui_pop recharge_pop" v-if="rechargePop" @click="$event.stopPropagation();">
    <div class="Page rechargePage" v-if="!showPop">
      <p class="title">
        星星充值
    ...
    <pop-Alert :showPop="showPop" @close="close" @confirm="confirm" btnTxt1="已取消" btnTxt2="已支付" type="2">
      <p>请确认是否已完成支付</p>
    </pop-Alert>
  </div>
</template>
...
import Vue from 'vue';
import { getUrlParamExceptBaseParam, isWeixin } from '../../../libs/utils';
export default {
