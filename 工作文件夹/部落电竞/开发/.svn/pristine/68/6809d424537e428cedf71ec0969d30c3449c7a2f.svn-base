  ...
  <div class="ui_pop">
    ...
    <section class="receive_adress">
      ...
      <div>
        ...
        <input v-model="address.receiverPhone" @blur="scrollToTop" type="tel" maxlength="11" id="phone_num"
          placeholder="请输入手机号码">
      </div>
      <div>
        <label>所在地区</label>
      ...
      <div class="detail_adress">
        <span>详细地址：</span>
        <textarea v-model="address.receiverAddress" @blur="scrollToTop" name="" id="" cols="30" rows="4"
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      return this.$post("/api/shopAddress/saveAddress", this.address)
        .then(rsp => {
          console.log(rsp);
