<template>
  <div class="Page goodsListPage">
    ...
    <div class="main" id='mainId'>
      ...
      <mescroll v-show="dataFlag==2" ref="mescroll" :downLoadAuto="false" :isUseDown="false" @upCallback="upCallback" @mescrollInit="mescrollInit">
...
export default {
  ...
  created() {
    if (this.$route.params.pageType) {
      ...
      if (this.$route.params.tabFlag == true || this.$route.params.tabFlag == 'true') {
        this.tabFlag = true;
      } else {
        this.tabFlag = false;
      }
