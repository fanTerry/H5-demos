    ...
    <div class="main" id='mainId'>
      ...
      <mescroll ref="mescroll" @downCallback="downCallback" @upCallback="upCallback" @mescrollInit="mescrollInit">
        ...
        <section class="banlance">
          ...
          <p style="padding-top: 8px;">冻结星星</p>
          <div>
            <span class="num" style="color: #999;">{{freezedbalance || '0.00'}}</span>
          </div>
        </section>
          ...
          <section class="record_list">
            <div class="item" v-for="(walletLog,index) in item.dataList" :key="index">
              ...
              <div class="tar">
                ...
                <span class="balance">冻结余额 {{walletLog.recFreezedScore||'0.00'}}</span>
              </div>
...
export default {
  ...
  methods: {
    ...
    getPageData(param) {
      ...
      return this.$post('/agency/usercenter/getWalletLog', param)
        .then(rsp => {
          ...
          if (dataResponse.code == '200') {
            ...
            if (dataResponse.data) {
              if (param.type === 0) {
                ...
                this.freezedbalance = dataResponse.data.freezedbalance;
              }
    ...
    getUserWallet() {
      return this.$post('/agency/starNum/queryStarNum')
        .then(rsp => {
          const dataResponse = rsp;
          if (dataResponse.code == 200) {
            this.balance = dataResponse.data.ableRecScore;
          }
        })
        .catch(error => {
          console.log(error);
