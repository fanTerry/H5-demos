  ...
  <div class="Page userCenter_Page">
    <div class="main">
      ...
      <section class="banlance">
        <p>星星余额</p>
        <div>
          <span class="num" v-if="getVuexUserInfo.recScore!=null">{{getVuexUserInfo.recScore.toFixed(2)}}</span>
        ...
        <div class="swiper-container swiper_service">
          <ul class="swiper-wrapper">
            <li class="list swiper-slide">
              ...
              <div class="item" @click='toJinLiMall()'>
                <img src="../../assets/images/user_center/follow_record_icon.png" alt="">
                <p>锦鲤商城</p>
              </div>
            </li>
      ...
      <section class="exchange_store">
        ...
        <div class="exchange">
          <p>可兑换星星额度：<span>
            ...
            </span><i class="rules_icon" @click="showRulesPop()"></i>
          </p>
          <p>
            椰子分:<span>{{getVuexUserInfo.yeYunPoints}}</span>
            <a class="btn" @click="popUps.showExchangeType = true">椰子分兑换</a></p>
        </div>
        <section class="store">
          <div class="store_item" @click="goToYeYunPage()">
            ...
            <!-- 跑马灯 -->
            <section class="mod_award" v-show="this.prizeList.length">
              <!-- <i class="horn_icon"></i> -->
    ...
    <!-- 椰子积分兑换规则 -->
    <div class="exchange_rule_pop" v-if="popUps.showRulesPop">
      <p>1. 实际可兑换星星余额为用户星星返奖总额-星星已兑总额；</p>
      <p>2. 1星星可兑换1椰子分，椰子分可在椰子商城兑换各种商品。</p>
    </div>
  ...
  methods: {
    ...
    closeShowRulesPop() {
      document.addEventListener('click', e => {
        if (this.popUps.showRulesPop) {
          var rulePopDom = document.getElementsByClassName('exchange_rule_pop')[0];
          ...
          if (!ruleIconDom.contains(e.target) && !rulePopDom.contains(e.target)) {
            this.popUps.showRulesPop = false;
          }
        }
      });
    },
