<template>
  <div class="Page orangeGamePage">
    ...
    <div class="main" id='mainId'>
      ...
      <mescroll id="mescroll" ref="mescroll" @downCallback="downCallback" @upCallback="upCallback"
        @mescrollInit="mescrollInit">
        <div class="scroll_wrapper">
          <banner class="banner" ref="banner" v-if="adList.length >0" :adList="adList">
          </banner>
            ...
            <template v-for="(item,index) in newsList">
              ...
              <article class="item film_item" v-else-if="item.type==2" :key="index">
                <div class="film_con">
                  ...
                  <div class="film_title" @click="toCmsDetail(item.aricleId,item.type)" v-html="item.detail"></div>
  ...
  methods: {
    ...
    handleMescrollY() {
      ...
      for (var i = 0; i < this.newsList.length; i++) {
        topArr[i] = parseInt(
          inforList.childNodes[i].getBoundingClientRect().top
        );
