...
public class QuizPlanRecommendManager {
     ...
     * @return
     */
    public CommonResponse<Boolean> judgeCanRecommend(BaseRequest baseRequest, Long orderId) {
        ...
        if (!quizPlanModelResult.isSuccess() || null == quizPlans) {
            return CommonResponse.withErrorResp("查询方案异常");
        }
        ...
        return CommonResponse.withErrorResp("未查询到相关方案");
    }
