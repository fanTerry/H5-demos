<template>
  <li class="guess_item guessItemPage" :class="{'match_end':matchInfo.matchStatus >=2}" @click="matchType!=1 && goUrlPage(matchInfo.matchId)">
    <div class="header">
      <div class="title">
        <div class="game_logo">
      ...
      <div class="more_options">
        ...
        <span class="start_time" v-if="matchInfo.matchStatus==2">{{matchInfo.startTime|formatByTime}}</span>
        <span v-if="matchInfo.canLive==1">直播</span>
      </div>
    ...
    <div class="con">
      <div class="battle_info">
        <span class="home_team_name" v-if="matchInfo.homeTeamNameAbbr">
          {{matchInfo.homeTeamNameAbbr|formatName(5)}}<i v-if="matchInfo.homeTeamNameAbbr.length > 6">..</i>
        </span>
        <span class="home_team_name" v-else-if="matchInfo.homeTeamName">
          {{matchInfo.homeTeamName|formatName(5)}}<i v-if="matchInfo.homeTeamName.length>6">..</i>
        </span>
        ...
        <span class="away_team_name" v-if="matchInfo.awayTeamNameAbbr">
          {{matchInfo.awayTeamNameAbbr|formatName(5)}}<i v-if="matchInfo.awayTeamNameAbbr.length>6">..</i>
        </span>
