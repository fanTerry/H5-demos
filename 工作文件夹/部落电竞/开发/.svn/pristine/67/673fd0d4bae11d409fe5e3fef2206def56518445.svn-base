  ...
  <div class='Page guessRankPage'>
    ...
    <div class="award" v-if="winTopResult">
      ...
      <div class="award_gift">
        ...
        <p class="gift_name" v-if="winTopResult.hd105GiftResponse==null && winTopResult.awardTtotal==null">暂无排行榜信息</p>
      </div>
    </div>
    <div class='main'>
      <mescroll :isUseDown="false" :isUseUp="false">
        <div v-if="winTopList">
          <h3>
          ...
          <ul class="award_list">
            <li v-for="(item,index) in winTopList" :key="index">
              ...
              <span class="num">{{item.awardTtotal}}</span>
