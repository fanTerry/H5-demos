    ...
    <div class="main">
      ...
      <div class="cmt_textarea">
        <div class="textarea_wrap">
          <textarea v-model="submitParam.content" @focus="bindFocus($event)" @blur="scrollToTop" name="" id="" maxlength="200" placeholder="请输入10个字以上的问题描述以便我们提供更好的帮助" ref="focusTextarea"></textarea>
      ...
      <div class="cmt_images">
        ...
        <div class="add_container">
          ...
          <div class="add_item" v-if="imgs.length<maxSize">
            ...
            <img src="" alt="" ref="img">
            <input style="position:absolute;opacity:0;" type="file" id='files' @change="fileChange($event)" ref="input" accept="image/*">
          </div>
        </div>
        <!-- <ul class="images">
          <li>
...
export default {
  ...
  methods: {
    ...
    submitFeedBack() {
      ...
      if (_self.submitParam.phone && !getCheck.checkPhone(_self.submitParam.phone)) {
