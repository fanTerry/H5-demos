        ...
        <div class="broadcast swiper-container">
          <ul class="swiper-wrapper">
            <template v-for="(item,index) in broacardList">
              <li class="swiper-slide" v-if="item.type == 4" :key="index">
                <span>恭喜</span>
...
.users {
  ...
  height: 18.4vw;
  text-align: center;
  @include getBgImg('../../../assets/images/game/newshake/avatar_bg.png');
  ...
  &::after {
    ...
    width: 14.4vw;
    height: 16.9333vw;
    @include getBgImg('../../../assets/images/game/newshake/avatar_border.png');
  }
  img {
    width: 12.2667vw;
    height: 12.2667vw;
...
.header_info {
  .assets {
    ...
    text-align: center;
    color: #fff;
    @include getBgImg('../../../assets/images/game/newshake/power_num_bg.png');
    background-size: contain;
    &:after {
      content: '';
      position: absolute;
      ...
      width: 6.9333vw;
      height: 6.9333vw;
      @include getBgImg('../../../assets/images/game/newshake/recharge_icon.png');
      background-size: contain;
    }
  }
  .herf_gather {
  ...
  .sign_icon {
    @include getBgImg('../../../assets/images/game/newshake/sign_icon.png');
    background-size: contain;
  }
  ...
  .exchange_icon {
    position: relative;
    @include getBgImg('../../../assets/images/game/newshake/more_icon.png');
    background-size: contain;
    ul {
  ...
  .exchange_icon {
    @include getBgImg('../../../assets/images/game/newshake/gift_icon.png');
    background-size: contain;
    span {
      @extend .g_c_mid;
  ...
  .broadcast {
    ...
    &::before {
      ...
      width: 80.9333vw;
      height: 10.8vw;
      @include getBgImg('../../../assets/images/game/newshake/paomadeng.png');
    }
    li {
      @extend .flex_v_h;
      height: 6.6667vw;
