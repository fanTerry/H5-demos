...
export default {
  ...
  methods: {
    ...
    getPageData(param) {
      ...
      return this.$post("/agency/expert/paid/articleList", param)
        .then(rsp => {
    ...
    setUserInfo(param) {
      ...
      console.log("分页参数", param);
      return this.$post("/agency/usercenter/ucIndexdata", param)
        .then(rsp => {
          const dataResponse = rsp;
          if (dataResponse.code == "200") {
            console.log(dataResponse.data, "setuserInfo---请求成功");
